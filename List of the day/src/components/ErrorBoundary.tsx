    ...
    if (this.state.hasError) {
      ...
      return (
        <div>
          ...
          <h2>
          Para solucionarlo, intente borrar sus archivos locales. (cookies y caché) y luego actualizar la página.
          Si el problema persiste, informe el problema a través de{"Valeria Sayago"}
            <StyledLink href="">
            </StyledLink>
            .
          </h2>
